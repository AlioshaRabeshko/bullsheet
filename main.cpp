...
int main(int argc, char *argv[])
{
    ...
    while (true)
    {
        ...
        else if (data[0] == "update " && data.size() >= 3 && data[data.size() - 1] == ";")
        {
            vector<string> tmp;
        ...
        else if (data[0] == "insert value " && data.size() >= 3 && data[data.size() - 1] == ";")
        {
            vector<string> tmp;
        ...
        else if (data[0] == "set structure " && data.size() >= 3 && data[data.size() - 1] == ";")
        {
            vector<string> tmp;
